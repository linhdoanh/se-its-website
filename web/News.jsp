...
<html style="font-size: 16px;">
    ...
    <body class="u-body u-xl-mode"><header class=" u-clearfix u-header u-section-row-container" id="sec-54ef"><div class="u-section-rows">
        ...
        <section class="u-clearfix u-custom-color-9 u-section-1" id="sec-99de">
            <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                <a href="News.jsp#carousel_412e" data-page-id="97002066" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-2 u-custom-font u-font-roboto-slab u-hover-palette-1-light-1 u-radius-50 u-btn-1">SỐ HÓA</a>
                <a href="News.jsp#carousel_26ff" data-page-id="97002066" class="u-border-none u-btn u-btn-round u-button-style u-custom-color-2 u-custom-font u-font-roboto-slab u-hover-palette-1-light-1 u-radius-50 u-btn-2">AI</a>
            </div>
        </section>
        <section class="u-clearfix u-section-2" id="sec-4f2e">
                    ...
                    <div class="u-layout-row">
                        <div class="u-size-30 u-size-60-md">
                            <div class="u-layout-col">
                                <div class="u-align-center u-container-style u-layout-cell u-shape-rectangle u-size-60 u-layout-cell-1">
                                    <c:set var="hotnew" value="${requestScope.HOT_NEWS}"/>
                                    <div class="u-container-layout u-container-layout-1">
                                        ...
                                        <h2 class="u-text u-text-1">
                                            <span style="font-weight: 700;">
                                                <a href="${hotnew.url}" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-1" target="_blank">${hotnew.title}</a>
                                            </span>
                                            <br>
                        ...
                        <div class="u-size-30 u-size-60-md">
                            <div class="u-layout-col">
                                <div class="u-size-30">
                                    <div class="u-layout-row">
                                        <c:set var="fourDigitalNew" value="${requestScope.FOUR_DIGITAL_NEWS}"/>
                                        <c:forEach var="digitalNew" items="${fourDigitalNew}">
                                            <div class="u-align-left u-container-style u-layout-cell u-shape-rectangle u-size-30 u-layout-cell-2">                                           
                                                <div class="u-container-layout u-container-layout-2">
                                                    <h4 class="u-text u-text-2">
                                                        <span style="font-weight: 700;">
                                                            <a href="${digitalNew.url}" class="u-btn u-button-link u-button-style u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-2" target="_blank">${digitalNew.title}</a>
                                                        </span>
                                                        <br>
                                                        <span style="font-size: 1.25rem;">${digitalNew.des}</span>
                                                    </h4>
                                                </div>                  
                                            </div>
                                        </c:forEach> 
<!--                                        <div class="u-align-left u-container-style u-layout-cell u-shape-rectangle u-size-30 u-layout-cell-3">
                                            <div class="u-container-layout u-valign-top u-container-layout-3">
                                                <h4 class="u-text u-text-3">
                                                    <span style="font-weight: 700;">
                                                        <a href="https://vnexpress.net/noi-am-anh-khi-choi-tien-so-4429301.html" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-3" target="_blank">Nỗi ám ảnh khi chơi tiền số</a>
                                                    </span>
                                                    <br>
            ...
            <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
                <div class="u-layout">
                    <div class="u-layout-col">
                        <div class="u-size-30">
                            <div class="u-layout-row">
                                <c:set var="digitalAndAINew" value="${requestScope.DIGITAL_AI_NEW}"/>
                                <c:forEach var="daNew" items="${digitalAndAINew}">
                                <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-1">
                                    <div class="u-container-layout u-container-layout-1">
                                        <img class="u-expanded-width u-image u-image-round u-radius-10 u-image-1" src="${daNew.image}" alt="" data-image-width="680" data-image-height="383">
                                        <h4 class="u-text u-text-1">
                                            <a href="${daNew.url}" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-1" target="_blank">${daNew.title}</a>
                                            <br>
                                            <span style="font-size: 1rem; font-weight: 400;">${daNew.des}</span>
                                            <br>
                                        </h4>
                                    </div>
                                </div>
...
<!--                                <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-3">
                                    <div class="u-container-layout u-valign-top u-container-layout-3">
                                        ...
                                        <h4 class="u-text u-text-3">
                                            <span style="font-weight: 700;">
                                                <a href="https://vnexpress.net/nokia-tu-bo-mang-smartphone-cao-cap-4437453.html" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-3" target="_blank"> Nokia từ bỏ mảng smartphone cao cấp</a>
                                            </span>
                                            <br>
...
<!--                        <div class="u-size-30">
                            <div class="u-layout-row">
                                <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-4">
                                    <div class="u-container-layout u-container-layout-4">
                                        <img class="u-image u-image-round u-radius-10 u-image-4" src="assets/images/ceo.jpg" alt="" data-image-width="680" data-image-height="453">
                                        <h4 class="u-text u-text-4">
                                            <span style="font-weight: 700;">
                                                <a href="https://vnexpress.net/giai-dap-truc-tuyen-ve-tien-dien-tu-nft-tren-ebox-4437227.html" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-4" target="_blank">Giải đáp trực tuyến về tiền điện tử, NFT trên eBox</a>
                                            </span>
                                            <br>
