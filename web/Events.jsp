...
<html style="font-size: 16px;">
    ...
    <body class="u-body u-xl-mode"><header class=" u-clearfix u-header u-section-row-container" id="sec-54ef"><div class="u-section-rows">
        ...
        <section class="u-clearfix u-valign-middle u-section-3" id="carousel_4e51">
            <div class="u-clearfix u-expanded-width u-gutter-0 u-layout-wrap u-layout-wrap-1">
                <div class="u-layout">
                    <div class="u-layout-row">
                        <div class="u-size-30 u-size-60-md">
                            <div class="u-layout-col">
                                <c:set var="hotnew" value="${requestScope.HOT_EVENTS}"/>
                                <div class="u-align-center u-container-style u-layout-cell u-shape-rectangle u-size-60 u-layout-cell-1">
                                    <div class="u-container-layout u-container-layout-1">
                                        <img class="u-border-2 u-border-black u-image u-image-default u-image-1" src="${hotnew.image}" alt="" data-image-width="680" data-image-height="407">
                                        <h2 class="u-text u-text-1">
                                            <span style="font-weight: 700;">
                                                <a href="detailEvents?eid=${hotnew.id}" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-1" target="_blank">${hotnew.title}</a>
                                            </span>
                                            <br>
                                            <span style="font-size: 1.5rem;">${hotnew.des}</span>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="u-size-30 u-size-60-md">
                            <div class="u-layout-col">
                                <div class="u-size-30">
                                    <div class="u-layout-row">
                                        <c:set var="bigEvent" value="${requestScope.BIG_EVENTS}"/>
                                        <c:forEach var="listBigEvent" items="${bigEvent}">
                                        <div class="u-align-left u-container-style u-layout-cell u-shape-rectangle u-size-30 u-layout-cell-2">
                                            <div class="u-container-layout u-container-layout-2">
                                                <h4 class="u-text u-text-2">
                                                    <span style="font-weight: 700;">
                                                        <a href="detailEvents?eid=${listBigEvent.id}" class="u-btn u-button-link u-button-style u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-2" target="_blank">${listBigEvent.title}</a>
                                                    </span>
                                                    <br>
                                                    <span style="font-size: 1.25rem;">${listBigEvent.des}</span>
                                                </h4>
                                            </div>
                                        </div>
                                        </c:forEach>
<!--                                        <div class="u-align-left u-container-style u-layout-cell u-shape-rectangle u-size-30 u-layout-cell-3">
                                            <div class="u-container-layout u-valign-top u-container-layout-3">
                                                <h4 class="u-text u-text-3">
                                                    <span style="font-weight: 700;">
                                                        <a href="Event3.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-3" target="_blank">Khởi động cuộc thi lập trình Zoohackthon Vietnam 2021</a>
                                                    </span>
                                                    <br>
...
<!--                                <div class="u-size-30">
                                        ...
                                        <div class="u-align-left u-container-style u-layout-cell u-shape-rectangle u-size-30 u-layout-cell-4">
                                            <div class="u-container-layout u-container-layout-4">
                                                <h4 class="u-text u-text-4">
                                                    <span style="font-weight: 700;">
                                                        <a href="Event4.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-4" target="_blank"> Đường đua FPT Uni Secathon mùa 4 chính thức quay trở lại</a>
                                                    </span>
                                                    <br>
                                        ...
                                        <div class="u-align-left u-container-style u-layout-cell u-shape-rectangle u-size-30 u-layout-cell-5">
                                            <div class="u-container-layout u-valign-top u-container-layout-5">
                                                <h4 class="u-text u-text-5">
                                                    <span style="font-weight: 700;">
                                                        <a href="Event5.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-5" target="_blank"> Career Talk: Cơ hội thực tập tại FPT Software dành cho sinh viên ĐH FPT</a>
                                                    </span>
                                                    <br>
        ...
        <section class="u-clearfix u-section-4" id="sec-95ce">
            <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
                <div class="u-layout">
                    <div class="u-layout-col">
                        <div class="u-size-30">
                            <div class="u-layout-row">
                                <c:set var="normalEvent" value="${requestScope.NORMAL_EVENTS}"/>
                                <c:forEach var="listNormalEvent" items="${normalEvent}">
                                <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-1">
                                    <div class="u-container-layout u-container-layout-1">
                                        <img class="u-expanded-width u-image u-image-round u-radius-10 u-image-1" src="${listNormalEvent.image}" alt="" data-image-width="680" data-image-height="383">
                                        <h4 class="u-text u-text-1">
                                            <a href="detailEvents?eid=${listNormalEvent.id}" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-1" target="_blank">${listNormalEvent.title}</a>
                                            <br>
                                            <span style="font-size: 1rem; font-weight: 400;">${listNormalEvent.des}</span>
                                            <br>
                                        </h4>
                                    </div>
                                </div>
...
<!--                                <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-2">
                                    <div class="u-container-layout u-container-layout-2">
                                        ...
                                        <h4 class="u-text u-text-2">
                                            <span style="font-weight: 700;">
                                                <a href="Event7.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-2" target="_blank"> Diễn đàn Công nghệ FPT Techday 2020 sắp tổ chức tại TP.HCM vào ngày 19.11</a>
                                            </span>
                                            <br>
...
<!--                                <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-3">
                                    <div class="u-container-layout u-valign-top u-container-layout-3">
                                        <img class="u-expanded-width u-image u-image-round u-radius-10 u-image-3" src="assets/images/KSPM.jpg" alt="" data-image-width="674" data-image-height="380">
                                        <h4 class="u-text u-text-3">
                                            <span style="font-weight: 700;">
                                                <a href="Event8.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-3" target="_blank"> Talkshow kỹ sư phần mềm: Con đường và sự nghiệp dành cho sinh viên ĐH FPT</a>
                                            </span>
                                            <br>
...
<!--                        <div class="u-size-30">
                            <div class="u-layout-row">
                                <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-4">
                                    <div class="u-container-layout u-container-layout-4">
                                        <img class="u-image u-image-round u-radius-10 u-image-4" src="assets/images/people.jpg" alt="" data-image-width="680" data-image-height="453">
                                        <h4 class="u-text u-text-4">
                                            <span style="font-weight: 700;">
                                                <a href="Event9.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-4" target="_blank">Lần đầu tiên Việt Nam tổ chức hội nghị quốc tế về ngôn ngữ học máy tính</a>
                                            </span>
                                            <br>
                                            <span style="font-size: 1rem;">Việc tổ chức PACLING 2019 là nỗ lực của Đại học FPT trong việc thúc đẩy phong trào nghiên cứu khoa học trong nhà trường cũng như khẳng định vị thế của trường đối với cộng đồng học thuật quốc tế.</span>
                                        </h4>
                                    </div>
                                </div>
                                <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-5">
                                    <div class="u-container-layout u-container-layout-5">
                                        ...
                                        <h4 class="u-text u-text-5">
                                            <span style="font-weight: 700;">
                                                <a href="Event10.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-5" target="_blank">Tìm hiểu về Trí Tuệ Nhân Tạo (AI) – Công nghệ đột phá và dẫn dầu trong cuộc CMCN 4.0</a>
                                            </span>
                                            <br>
                                ...
                                <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-6">
                                    <div class="u-container-layout u-container-layout-6">
                                        <img class="u-expanded-width u-image u-image-round u-radius-10 u-image-6" src="assets/images/careerfair2.png" alt="" data-image-width="1200" data-image-height="630">
                                        <h4 class="u-text u-text-6">
                                            <span style="font-weight: 700;">
                                                <a href="Event11.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-9 u-text-black u-text-hover-custom-color-9 u-btn-6" target="_blank"> FPTU Career Fair 2021 – Ngày hội việc làm lớn nhất trong năm tại ĐH FPT chính thức khởi động</a>
                                            </span>
                                            <br>
