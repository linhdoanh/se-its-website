<%-- 
    Document   : DetailEvents
    Created on : Mar 22, 2022, 4:50:24 PM
    Author     : PC
--%>
...
<html style="font-size: 16px;">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/Event1.css" media="screen">
    ...
    <body class="u-body u-xl-mode"><header class=" u-clearfix u-header u-section-row-container" id="sec-54ef"><div class="u-section-rows">
                        ...
                        <div class="u-layout-row">
                            <div class="u-align-center-md u-align-center-sm u-align-center-xs u-container-style u-layout-cell u-left-cell u-size-31-lg u-size-31-xl u-size-60-md u-size-60-sm u-size-60-xs u-layout-cell-1">
                                <div class="u-container-layout u-container-layout-1">
                                    <h2 class="u-text u-text-1"> ${detail.title}
                                    </h2>
                                    <p class="u-custom-font u-font-roboto-slab u-large-text u-text u-text-variant u-text-white u-text-2"> ${detail.content}
                                    </p>
                                </div>
                            </div>
                            <div class="u-align-center u-container-style u-layout-cell u-right-cell u-size-29-lg u-size-29-xl u-size-60-md u-size-60-sm u-size-60-xs u-layout-cell-2">
                                <div class="u-container-layout u-container-layout-2">
                                    <img class="u-image u-image-1" src="${detail.image}" data-image-width="1200" data-image-height="1200">
                                    <p class="u-large-text u-text u-text-custom-color-9 u-text-variant u-text-3"> ${detail.qoutes}</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="u-clearfix u-section-2" id="sec-2f31">
