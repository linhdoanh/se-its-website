<%-- 
    Document   : Homepage
    Created on : Mar 9, 2022, 8:42:43 PM
    Author     : PC
--%>
...
<html style="font-size: 16px;">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/Homepage.css" media="screen">
    ...
    <body class="u-body u-xl-mode"><header class=" u-clearfix u-header u-section-row-container" id="sec-54ef"><div class="u-section-rows">
        ...
        <section class="u-align-center u-clearfix u-section-1" id="carousel_614e">
            <div class="u-clearfix u-sheet u-sheet-1">
                    ...
                    <div class="u-clearfix u-layout-wrap u-layout-wrap-1">
                        <div class="u-layout">
                            ...
                            <div class="u-container-style u-image u-layout-cell u-left-cell u-size-30 u-image-1" data-image-width="626" data-image-height="939">
                                <div class="u-container-layout u-container-layout-1"></div>
                            </div>
                                
                            <div class="u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                                <c:set var="homepage" value="${requestScope.HOMEPAGE}"/>
                                <div class="u-container-layout u-container-layout-2">
                                    <h2 class="u-custom-font u-font-roboto-slab u-text u-text-1">
                                        <span style="font-weight: 700; font-size: 3rem;">SE</span>&nbsp;VÀ&nbsp;<span style="font-weight: 700; font-size: 3rem;">ITs</span>
                                        <br>${homepage.title}<br>
                                    </h2>
                                    <p class="u-text u-text-default u-text-grey-40 u-text-2">${homepage.des} 
                                    </p>
                                    <a href="SubjectServlet" data-page-id="77722378" class="u-border-none u-btn u-btn-round u-button-style u-gradient u-none u-radius-7 u-text-custom-color-2 u-btn-1">read more</a>
                                </div>
                            </div>
                        </div>
                    </div>
